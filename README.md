...
## Veryfi Lens Bank Statements Android Example <a name="example"></a>
This is an example of how to use Veryfi Lens Bank Statements in your app, you can find the developer documentation [here](https://app.veryfi.com/lens/docs/android/).

![LensBankStatementsExample](barcodes-demo.gif)

## How to add Veryfi Lens Bank Statements to your project <a name="maven"></a>
...
```ruby
dependencies {
    implementation 'com.veryfi.lens:veryfi-lens-bank-statements-sdk:2.1.0.30'
}
```
